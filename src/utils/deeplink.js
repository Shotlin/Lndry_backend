...
const CUSTOMER_ROUTES = {
  ...
  order_tracking: '/orders/details/:orderId',
  order_approval: '/orders/details/:orderId',
  order_payment: '/orders/details/:orderId',
  order_review: '/orders/details/:orderId',
...
const CAPTAIN_ROUTES = {
  ...
  order_tracking: '/rider/jobs/:orderId',
  order_approval: '/rider/jobs/:orderId',
  order_payment: '/rider/jobs/:orderId',
  order_review: '/rider/jobs/:orderId',

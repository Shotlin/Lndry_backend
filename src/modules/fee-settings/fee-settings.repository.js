...
const COLUMNS = `
  ...
  delivery_fee_enabled, delivery_fee_mode, min_delivery_fee, base_distance_km, per_km_fee,
  max_delivery_distance_km, free_delivery_enabled, free_delivery_above,
  vendor_commission_enabled, vendor_commission_type, vendor_commission_value,
  vendor_commission_label, vendor_commission_description,
...
const UPDATABLE_COLUMNS = [
  ...
  'vendor_commission_label',
  'vendor_commission_description',

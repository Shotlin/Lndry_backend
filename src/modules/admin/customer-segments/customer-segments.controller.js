...
export class CustomerSegmentsController {
  ...
  async getMembers(request, reply) {
    ...
    // Flat page/limit/total/totalPages meta, matching LNDRY's convention
    // (e.g. vendors.controller.js) rather than Bakaloo's nested `pagination` object.
    return reply.code(200).send(success(data.members, 'Segment members fetched', data.pagination))
  }

 ...
 * coupon targeting and (later) notification targeting.
 * Ported from bakaloo-backend (see CLAUDE.md's "Bakaloo Feature Port" section).
 */
export class CustomerSegmentsRepository {
  ...
  /** True if userId is a member of segmentId — used by coupon eligibility checks (Phase 2). */
